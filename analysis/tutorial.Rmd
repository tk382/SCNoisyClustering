...
There are other options for consensus clustering in LSLSL function. The following chunk arranges the data set into a 4 dimensional array for the specification of package "diceR." [@diceR]
