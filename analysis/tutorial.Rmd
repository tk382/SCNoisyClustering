...
```{r pca, fig.width=3, fig.height=3}
library(irlba)
...
```{r similarity_matrix, fig.width=3, fig.height=3}
heat(out$S)
```
...
```{r dimred, fig.width=3, fig.height=3}
tsne = out$tsne
...
```{r ref_analyze, fig.width=3, fig.height=3}
...
```{r ref_analyze2, fig.width=3, fig.height=3}
...
```{r ref_analyze3, fig.width=3, fig.height=3}
...
```{r tissueref_analyze, fig.width=3, fig.height=3}
