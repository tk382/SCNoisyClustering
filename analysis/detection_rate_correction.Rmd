...
```{r Kolod, include = FALSE, echo=FALSE, eval = FALSE}
i = 1
...
set.seed(1)
res1 = SLSL2(X, log=T, filter=F, correct_detection_rate = T, numClust = numClust)
adj.rand.index(res1$result, truth)

set.seed(1)
res2 = SLSL2(X, log=T, filter=F, correct_detection_rate = F, numClust = numClust)
