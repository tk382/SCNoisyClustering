...
set.seed(1); res1 = SLSL(R, log=F, filter=F, correct_detection_rate = F)
adj.rand.index(res1$result, truth)

set.seed(1); res2 = SLSL(X, log=T, filter=F, correct_detection_rate = F)
adj.rand.index(res2$result, truth)

set.seed(1); res3 = SLSL(X, log=T, filter=F, correct_detection_rate = T)
